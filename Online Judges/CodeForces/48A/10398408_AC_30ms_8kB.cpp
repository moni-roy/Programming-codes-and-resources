...
int main()
{
	...
	cin>>s1>>s2>>s3;
	if(s1=="paper" && s2=="rock" && s3=="rock") Ans = "F";
	else if(s1=="scissors" && s2=="paper" && s3=="paper") Ans = "F";
	else if(s1=="rock" && s2=="scissors" && s3=="scissors") Ans = "F";
	
	else if(s2=="paper" && s1=="rock" && s3=="rock") Ans = "M";
	else if(s2=="scissors" && s1=="paper" && s3=="paper") Ans = "M";
	else if(s2=="rock" && s1=="scissors" && s3=="scissors") Ans = "M";
	
	else if(s3=="paper" && s1=="rock" && s2=="rock") Ans = "S";
	else if(s3=="scissors" && s1=="paper" && s2=="paper") Ans = "S";
	else if(s3=="rock" && s1=="scissors" && s2=="scissors") Ans = "S";
	else Ans = "?";
	cout<<Ans<<endl;	
	return 0;
}

...
int main()
{
	...
	if(mp[0]==-2 && mp[1]==0 && mp[2]==2) cout<<"ABC"<<endl;
	else if(mp[0]==-2 && mp[1]==2 && mp[2]==0) cout<<"ACB"<<endl;
	
	else if(mp[0]==0 && mp[1]==-2 && mp[2]==2) cout<<"BAC"<<endl;
	else if(mp[0]==0 && mp[1]==2 && mp[2]==-2) cout<<"CAB"<<endl;
	
	else if(mp[0]==2 && mp[1]==0 && mp[2]==-2) cout<<"CBA"<<endl;
	else if(mp[0]==2 && mp[1]==-2 && mp[2]==0) cout<<"BCA"<<endl;
